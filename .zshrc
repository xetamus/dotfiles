...
if [[ "$(uname)" == "Linux" ]]; then
  ...
  ln -sf ${HOME}/.config/alacritty/alacritty-linux.yml ${HOME}/.config/alacritty/alacritty.yml
elif [[ "$(uname)" == "Darwin" ]]; then
  export DARWIN_ENV=1
  alias ls="ls -G"
  ln -sf ${HOME}/.config/alacritty/alacritty-mac.yml ${HOME}/.config/alacritty/alacritty.yml
else
  ln -sf ${HOME}/.config/alacritty/alacritty-win.yml ${HOME}/.config/alacritty/alacritty.yml
fi
